...
public class SearchCriteria {
	...
	public boolean isEmpty() {
		return (StringUtils.isEmpty(this.tenantId) && StringUtils.isEmpty(this.mobileNumber)
				...
				&& StringUtils.isEmpty(this.toDate) && StringUtils.isEmpty(this.connectionType));
	}
	...
	public boolean tenantIdOnly() {
		return (this.tenantId != null && this.status == null && this.ids == null && this.applicationNumber == null
				...
				&& this.fromDate == null && this.toDate == null && this.ownerIds == null && this.propertyId == null && this.connectionType == null);
	}
